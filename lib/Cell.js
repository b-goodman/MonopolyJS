...
var Cell = /** @class */ (function () {
    ...
    Cell.prototype.isMortgageActionValid = function (action) {
        ...
        switch (action) {
            ...
            case "unmortgage":
                ...
                else if ((Rules_1.Rules.PROPERTY_MORTGAGE_INTEREST_RATE_ENABLED && Players_1.Players.get(this.currentOwner).cash < this.mortgageValue + (this.mortgageValue / Rules_1.Rules.PROPERTY_MORTGAGE_INTEREST_RATE_VALUE)
                    || (!Rules_1.Rules.PROPERTY_MORTGAGE_INTEREST_RATE_ENABLED && Players_1.Players.get(this.currentOwner).cash < this.mortgageValue))) {
    ...
    Cell.prototype.getOwningPlayerGroupID = function () {
        return this.getOwningPlayerOwnership().map(function (cell) { return cell.groupID; });
    };
    /**
    ...
    Cell.prototype.memberGroupMortgageCount = function () {
        return this.getPropertyGroupMembers().filter(function (cell) { return cell.mortgageState == true; }).length;
    };
    /**
        ...
        if (this.mortgageState) {
            ...
            switch (this.type) {
                ...
                case "UTILITY":
                    ...
                    if (utilitiesOwned > 0)
                        returnCase = this.rent[utilitiesOwned - 1] * Dice_1.Dice.value;
                    break;
            }
        }
        return returnCase;
